...
const s = {
  ...
  groupLabel: { fontSize:10, fontWeight:700, color:"#4338ca", letterSpacing:".08em", padding:"14px 20px 5px", textTransform:"uppercase" },
  link:       { display:"flex", alignItems:"center", gap:10, padding:"10px 20px", color:"#a5b4fc", textDecoration:"none", fontSize:13, borderLeft:"3px solid transparent", transition:"all .15s" },
  linkActive: { color:"#fff", background:"#312e81", borderLeftColor:"#818cf8" },
  linkIcon:   { fontSize:16, flexShrink:0 },
  userBox:    { display:"flex", alignItems:"center", gap:10, padding:"14px 16px", borderTop:"1px solid #312e81", flexShrink:0 },
  avatar:     { width:32, height:32, borderRadius:"50%", color:"#fff", display:"flex", alignItems:"center", justifyContent:"center", fontSize:13, fontWeight:700, flexShrink:0 },
  userInfo:   { flex:1, overflow:"hidden" },
  userName:   { color:"#e0e7ff", fontSize:13, fontWeight:600, whiteSpace:"nowrap", overflow:"hidden", textOverflow:"ellipsis" },
  userRole:   { color:"#818cf8", fontSize:11 },
  logoutBtn:  { background:"none", border:"none", color:"#6366f1", cursor:"pointer", fontSize:18, padding:"4px", lineHeight:1, flexShrink:0 },
};
